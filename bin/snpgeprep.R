...
#ge.results <- ge.results[1:2,]#remove me later after testing complete

ge.results <- ge.results[,1]

write.table (ge.results, file="ge_snp_sig_probes.tsv", row.names=FALSE, col.names=FALSE, quote=FALSE, sep="\t")
